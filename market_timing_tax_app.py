...
# Debug info
st.sidebar.markdown("---")
st.sidebar.write(f"Amplitude: {amplitude*100:.0f}%")
st.sidebar.write(f"Tax Rate: {tax_rate*100:.0f}%")
...
try:
    ...
    st.sidebar.success("✓ Market data generated")
except Exception as e:
    st.sidebar.error(f"Error generating market: {str(e)}")
    st.stop()
