...
def generate_simple_sine_wave(amplitude: float = 0.20) -> np.ndarray:
    """
    Generate TWO complete 8-year sine wave cycles.
    This allows entry at year 6 and still having 8 years of data.
    """
    months = 16 * 12 + 1  # 16 years to allow for late entries
